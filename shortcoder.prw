...
Static Function ShowBBSHelp(cEsc, nWidth)
    ...
    ConOut(BoxBlank(cEsc, nInner, "1;33"))
    ConOut(BoxSection(cEsc, "ATALHOS DE TECLADO:", nInner, "1;33"))
    ConOut(BoxCmdLine(cEsc, "up / down", "Navega historico dos ultimos 20 comandos", nInner, "1;33"))
    ConOut(BoxCmdLine(cEsc, "left / right", "Move o cursor na linha", nInner, "1;33"))
    ConOut(BoxCmdLine(cEsc, "Ctrl+A / Ctrl+E", "Vai para inicio / fim da linha", nInner, "1;33"))
    ConOut(BoxCmdLine(cEsc, "Ctrl+U / Ctrl+K", "Apaga ate o inicio / fim da linha", nInner, "1;33"))
    ConOut(BoxCmdLine(cEsc, "Ctrl+L", "Limpa a tela (mantem a linha)", nInner, "1;33"))
    ConOut(BoxCmdLine(cEsc, "Ctrl+C", "Cancela a linha atual", nInner, "1;33"))
    ConOut(BoxCmdLine(cEsc, "Ctrl+D", "Sai (em linha vazia)", nInner, "1;33"))
    ConOut(BoxBlank(cEsc, nInner, "1;33"))
